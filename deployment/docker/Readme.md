...
Production images for each tag, latest and the development branch will be pushed to [docker hub](https://hub.docker.com/r/distroui/distro).
...
this will create an image called `distroui/distro:latest` which will be compiled from the currently checked out code
