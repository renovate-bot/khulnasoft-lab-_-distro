export default {
  ...
  firstlyYouNeedAccessToTheServerWhereKhulnasoftRunni: 'Tout d\'abord, vous avez besoin d\'accéder au serveur où Khulnasoft est en cours d\'exécution.',
  ...
  khulnasoftUserList: 'liste d\'utilisateurs Khulnasoft',
  youCanChangePasswordOfExistingUser: 'Vous pouvez changer le mot de passe de l\'utilisateur existant :',
  khulnasoftUserChangebyloginLoginUser123Password: 'khulnasoft user change-by-login --login user123 --password {makePasswordExample}',
  ...
  ansibleKhulnasoft: 'Khulnasoft Ansible',
