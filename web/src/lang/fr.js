export default {
  ...
  firstlyYouNeedAccessToTheServerWhereDistroRunni: 'Tout d\'abord, vous avez besoin d\'accéder au serveur où Distro est en cours d\'exécution.',
  ...
  distroUserList: 'liste d\'utilisateurs Distro',
  youCanChangePasswordOfExistingUser: 'Vous pouvez changer le mot de passe de l\'utilisateur existant :',
  distroUserChangebyloginLoginUser123Password: 'distro user change-by-login --login user123 --password {makePasswordExample}',
