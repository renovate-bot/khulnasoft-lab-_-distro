export default {
  ...
  firstlyYouNeedAccessToTheServerWhereDistroRunni: 'Во-первых, необходим доступ к серверу, на котором работает Distro.',
  ...
  distroUserList: 'Список пользователей distro',
