export default {
  ...
  firstlyYouNeedAccessToTheServerWhereKhulnasoftRunni: 'Zuerst benötigen Sie Zugriff auf den Server, auf dem Khulnasoft ausgeführt wird.',
  ...
  khulnasoftUserList: 'khulnasoft user list',
