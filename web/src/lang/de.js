export default {
  ...
  firstlyYouNeedAccessToTheServerWhereDistroRunni: 'Zuerst benötigen Sie Zugriff auf den Server, auf dem Distro ausgeführt wird.',
  ...
  distroUserList: 'distro user list',
