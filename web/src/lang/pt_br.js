export default {
  ...
  firstlyYouNeedAccessToTheServerWhereDistroRunni: 'Primeiramente, você precisa ter acesso ao servidor onde o Distro está em execução.',
  ...
  distroUserList: 'distro lista de usuários',
  youCanChangePasswordOfExistingUser: 'Você pode alterar a senha de um usuário existente:',
  distroUserChangebyloginLoginUser123Password: 'distro alterar-por-login --login usuário123 --senha {exemploDeSenha}',
