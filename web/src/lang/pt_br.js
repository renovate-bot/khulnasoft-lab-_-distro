export default {
  ...
  firstlyYouNeedAccessToTheServerWhereKhulnasoftRunni: 'Primeiramente, você precisa ter acesso ao servidor onde o Khulnasoft está em execução.',
  ...
  khulnasoftUserList: 'khulnasoft lista de usuários',
  youCanChangePasswordOfExistingUser: 'Você pode alterar a senha de um usuário existente:',
  khulnasoftUserChangebyloginLoginUser123Password: 'khulnasoft alterar-por-login --login usuário123 --senha {exemploDeSenha}',
  ...
  dashboard2: 'Painel',
  ansibleKhulnasoft: 'Ansible Khulnasoft',
