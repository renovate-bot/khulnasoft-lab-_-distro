export default {
  ...
  firstlyYouNeedAccessToTheServerWhereDistroRunni: 'Primero, deber tener acceso al servidor donde Distro está corriendo.',
  ...
  distroUserList: 'lista de usuarios de distro',
  youCanChangePasswordOfExistingUser: 'Puedes cambiar la contraseña del usuario existente:',
  distroUserChangebyloginLoginUser123Password: 'distro user change-by-login --login usuario123 --password {unaContraseñaDeEjemplo}',
